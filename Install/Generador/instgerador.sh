...
clear
[[ "$(whoami)" != "root" ]] && {
echo -e "\033[1;33m[\033[1;31mError\033[1;33m] \033[1;37m- \033[1;33mAnda harus menjalankan sebagai root\033[0m"
...
clear
echo -e "$barra"
echo -e "       \033[1;33mINSTALLER KUNCI SSHPLUS MANAJER !\033[0m"
echo -e "$barra"
echo ""
read -p "$(echo -e "\033[1;36mAPAKAH ANDA INGIN LANJUTKAN? \033[1;31m? \033[1;33m[S/N]:\033[1;37m ")" -e -i s resp
[[ $resp = @(n|N) ]] && rm $HOME/instgerador.sh* && exit 0
echo
tput cuu1 && tput dl1
tput cuu1 && tput dl1
echo -e "\033[1;36mMEMPERBARUI REPOSITORY...... \033[1;32mAGUARDE"
fun_bar 'fun_attrepo'
echo -e "\033[1;36mMENGINSTAL FITUR........... \033[1;32mAGUARDE"
fun_bar 'fun_instrec'
echo -e "\033[1;36mMENYIAPKAN APACHE............ \033[1;32mAGUARDE"
fun_bar 'fun_apalist'
echo -e "\033[1;36mPERSIAPAN SISTEM............ \033[1;32mAGUARDE"
fun_bar 'fun_preparasis'
echo -e "\033[1;36mDONWLOAD SERVER.............. \033[1;32mAGUARDE"
fun_bar 'fun_downser'
echo -e "\033[1;36mMENGINSTAL SISTEM............ \033[1;32mAGUARDE"
fun_bar 'fun_instsis'
echo -e "\033[1;36mIZIN FILE ............... \033[1;32mAGUARDE"
fun_bar 'fun_permisoarq'
echo -e "\033[1;36mMERAKIT LINK-IP ANDA ....... \033[1;32mAGUARDE"
fun_bar 'fun_montaip'
echo -e "\033[1;36mKONFIGURASI SELESAI.... \033[1;32mAGUARDE"
fun_bar 'fun_finconf'
echo -e "$barra"
...
echo -e "\033[1;31m\033[1;33mPERINTAH UTAMA: \033[1;32mkey keyssh \033[0m"
echo -e "\033[1;33mINFORMASI LEBIH LANJUT \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[0m"
